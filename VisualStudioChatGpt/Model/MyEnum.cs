...
namespace VisualStudioChatGpt.Model
{
    internal class TypeModel
    {
        ...
        internal static string FindBug = $"查找bugs,中文回复,尽量回复简短一点";
        internal static string Optimize = $"请优化代码 , 不要说明,{common}";
        internal static string Explain = $"请帮我写个简短的解释说明 ,{common}";
        internal static string AddComment = $"请帮我添加方法注释说明 ,{common}";
        internal static string AddSummary = $"请提供方法的注释信息，而不是代码实现, 只要注释信息,不要其它任何多余的信息 中文回复,格式:summary形式。{common}";
